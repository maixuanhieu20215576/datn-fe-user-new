...
export default function ChatApp() {
  ...
  useEffect(() => {
    scrollToBottom(); // Cuộn xuống khi component được render lần đầu
  }, [messages]); // Cuộn xuống mỗi khi danh sách tin nhắn thay đổi
    ...
    <div className="h-screen w-full flex bg-white dark:bg-dark-900 text-gray-900 dark:text-white">
      ...
      {selectedChat && (
        <div className="flex-1 flex flex-col">
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-100 dark:bg-gray-800 hide-scrollbar">
